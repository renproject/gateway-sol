...
const networks = getDirectories(dirname)
    .filter(network => network !== "development");

for (const network of networks) {
    const directory = path.join(network, "/*.json");
            ...
            fs.readFile(file, 'utf8', function (err, data) { // Read each file
                ...
                try {
                    ...
                    const newObj = {
                        ...
                        sourcePath: obj.sourcePath && obj.sourcePath.replace ? obj.sourcePath.replace(/.*\/ren-sol\//g, "~/github/renproject/ren-sol/") : obj.sourcePath,
