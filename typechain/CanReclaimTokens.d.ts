...
interface CanReclaimTokensInterface extends ethers.utils.Interface {
  functions: {
...
export class CanReclaimTokens extends BaseContract {
  ...
  interface: CanReclaimTokensInterface;
