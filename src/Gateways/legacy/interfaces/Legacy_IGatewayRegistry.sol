...
import "./Legacy_IERC20Standard.sol";
import "./Legacy_IGateway.sol";
...
interface IGatewayRegistry {
    ...
    function getGatewayByToken(address _tokenAddress) external view returns (Legacy_IGateway);
    ...
    ///        lookup.
    function getTokenBySymbol(string calldata _tokenSymbol) external view returns (Legacy_IERC20Standard);
}
