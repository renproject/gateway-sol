...
contract Legacy_MintGatewayLogicV1 is
    Initializable,
    Legacy_Claimable,
    ...
    Legacy_MintGatewayStateV1
{
    ...
    function transferTokenOwnership(Legacy_MintGatewayLogicV1 _nextTokenOwner) public onlyOwner {
...
contract Legacy_BTCGateway is InitializableAdminUpgradeabilityProxy {}

contract Legacy_ZECGateway is InitializableAdminUpgradeabilityProxy {}

contract Legacy_BCHGateway is InitializableAdminUpgradeabilityProxy {}
